...
*  AMX Mod X script.
*
*   Female Ultimate Sounds (F_Ultimate_Sounds.sma)
...
{   
	...
	{
		last=players_ct[0]
		client_cmd(last,"spk misc/female/f_oneandonly")
	}
...
public hs()
{
	...
	if (hsmode_bit & 2)
	{
		for(new i=1;i<=get_maxplayers();i++) 
			if(is_user_connected(i)==1)
				client_cmd(i,"spk misc/female/f_headshot")
	}
}
...
public plugin_precache()
{
	...
	precache_sound("misc/female/f_godlike.wav")
	precache_sound("misc/female/f_headshot.wav")
	precache_sound("misc/female/f_humiliation.wav")
	...
	precache_sound("misc/female/f_oneandonly.wav")
	precache_sound("misc/female/f_rampage.wav")
	precache_sound("misc/female/f_holyshit.wav")
	precache_sound("misc/female/f_megakill.wav")
	precache_sound("misc/female/f_wickedsick.wav")
	precache_sound("misc/female/f_ludacrisskill.wav")
	precache_sound("misc/female/f_unstoppable.wav")
